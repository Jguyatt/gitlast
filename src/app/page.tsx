...
function TestimonialsMarquee() {
  ...
  const renderCol = (arr: typeof items, dir: 'up' | 'down', duration: number) => {
    ...
    const style = { '--duration': `${duration}s` } as CSSProperties;
        ...
        <div className="relative w-full px-6 py-16">
          <div id="download" className="mt-6 sm:mt-9 lg:mt-12">
            ...
            >
              ...
              >
                {!isDemoCompact ? (
                  <motion.div initial={{ opacity: 0, y: 8 }} animate={headingControls}>
                    <h1
                    ...
                    <div className="mt-12 flex flex-col sm:flex-row gap-6 justify-center items-center">
                      <button className="flex items-center gap-3 bg-white text-black px-6 py-3 rounded-xl font-semibold hover:bg-gray-100 transition-colors shadow-lg">
