      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <p className="text-gray-600 mb-8">
            These Terms of Service ("Terms") govern your use of Twinly, Inc.'s ("Twinly," "we," "our," or "us") AI communication platform and related services (collectively, the "Service"). By accessing or using our Service, you agree to be bound by these Terms.
          </p>
          
          <h2 className="text-2xl font-semibold text-gray-900 mt-8 mb-4">1. Acceptance of Terms</h2>
          <p className="text-gray-600 mb-4">
            By creating an account, accessing, or using our Service, you acknowledge that you have read, understood, and agree to be bound by these Terms and our Privacy Policy, which is incorporated herein by reference.
          </p>
          
          <h2 className="text-2xl font-semibold text-gray-900 mt-8 mb-4">2. Description of Service</h2>
          <p className="text-gray-600 mb-4">
            Twinly provides an AI-powered communication platform that assists users in managing, drafting, and optimizing their digital communications. The Service includes but is not limited to email management, response generation, and communication analytics.
          </p>
          ...
          <p className="text-gray-600 mb-4">
            You agree not to use the Service for any unlawful purpose or in any way that could damage, disable, overburden, or impair the Service. Prohibited uses include but are not limited to:
          </p>
          <ul className="text-gray-600 mb-4 list-disc pl-6">
            <li>Violating any applicable laws or regulations</li>
            <li>Transmitting harmful, threatening, or harassing content</li>
          ...
          <h3 className="text-xl font-semibold text-gray-900 mt-6 mb-3">5.1 Our Rights</h3>
          <p className="text-gray-600 mb-4">
            The Service and its original content, features, and functionality are owned by Twinly and are protected by international copyright, trademark, patent, trade secret, and other intellectual property laws.
          </p>
          
          <h3 className="text-xl font-semibold text-gray-900 mt-6 mb-3">5.2 Your Content</h3>
          <p className="text-gray-600 mb-4">
            You retain ownership of content you submit to the Service. By submitting content, you grant us a non-exclusive, royalty-free, worldwide license to use, modify, and display such content for the purpose of providing the Service.
          </p>
          ...
          <h3 className="text-xl font-semibold text-gray-900 mt-6 mb-3">7.1 Subscription Fees</h3>
          <p className="text-gray-600 mb-4">
            Certain features of the Service may require payment of subscription fees. All fees are non-refundable unless otherwise specified in writing.
          </p>
          ...
          <p className="text-gray-600 mb-4">
            The Service is provided "as is" and "as available" without warranties of any kind. We do not guarantee that the Service will be uninterrupted, error-free, or free of viruses or other harmful components.
          </p>
          
          <h3 className="text-xl font-semibold text-gray-900 mt-6 mb-3">8.2 Limitation of Liability</h3>
          <p className="text-gray-600 mb-4">
            To the maximum extent permitted by law, Twinly shall not be liable for any indirect, incidental, special, consequential, or punitive damages, including but not limited to loss of profits, data, or use, arising out of or relating to your use of the Service.
          </p>
          
          <h2 className="text-2xl font-semibold text-gray-900 mt-8 mb-4">9. Indemnification</h2>
          <p className="text-gray-600 mb-4">
            You agree to indemnify and hold harmless Twinly and its officers, directors, employees, and agents from any claims, damages, or expenses arising out of your use of the Service or violation of these Terms.
          </p>
          ...
          <div className="bg-gray-50 p-4 rounded-lg">
            ...
            <p className="text-gray-600 mb-2">Legal Department</p>
            <p className="text-gray-600 mb-2">Email: legal@twinly.com</p>
